...
export class ModalUserComponent implements OnInit {
  ...
  async delete(){
    this.users =  await this.httpService.patch(`user/${this.id}`, {});
    alert('deletado!')
  }

  async edit(){
    this.users =  await this.httpService.put('user', {id: this.id, password : this.password, cpassword : this.cpassword});
    alert('editado!')
  }
